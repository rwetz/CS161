 ...
 * Fragments 6.1
 *
 * Array-based implementation of an array list that is storing elements: (a)
 * shifting up for an insertion at index; (b) shifting down for a removal at
 * index i;
 *
...
public class ArrayList<E> implements List<E> {
    ...
    public boolean add(E e) {
        add(size, e); // Call the existing add(int i, E e) method with the current size as the index
